...
if ($op == 'delete') {
    ...
    $sql1 = "delete from data_aplikasi where id = '$id_aplikasi'";
...
if (isset($_POST['simpan'])) {
    ...
    if ($id_aplikasi && $nama && $lama_pengerjaan && $deskripsi && $progress) {
        if ($op == 'edit') { // untuk update
            $sql1 = "update data_aplikasi set id_aplikasi = '$id_aplikasi',nama= '$nama',lama_pengerjaan= '$lama_pengerjaan',deskripsi= '$deskripsi',progress= '$progress' where id = '$id'";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        <select name="nama_aplikasi" style="width:160px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql2 = "select * from data_aplikasi order by id_aplikasi desc";
                            ...
                            while ($r2 = mysqli_fetch_array($q2)) {
                                ...
                                <tr>
                                    ...
                                    <td scope="row">
                                        <a href="employee.php?op=persen&id=<?php echo $id_aplikasi?>"><button type="button"
                                                class="btn btn-info">%</button></a>
                                        <a href="employee.php?op=edit&id=<?php echo $id_aplikasi ?>"><button type="button"
                                                class="btn btn-warning">Edit</button></a>
                                        <a href="employee.php?op=delete&id=<?php echo $id_aplikasi ?>"
